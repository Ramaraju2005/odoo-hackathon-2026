...
export const TripsPage = () => {
  ...
  return (
    <div className="bg-[#F4F6F5] min-h-screen p-6 space-y-6">
      ...
      <div className={`grid grid-cols-1 ${isReadOnly ? "" : "lg:grid-cols-5"} gap-6 items-start`}>
        ...
        <section className={`${isReadOnly ? "" : "lg:col-span-3"} bg-white rounded-2xl border border-gray-100/50 shadow-xs p-5 space-y-5`}>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 max-w-sm w-full p-5 space-y-5">
            <div className="flex justify-between items-center border-b border-gray-100 pb-3">
              ...
              <button
                ...
                className="text-gray-400 hover:text-gray-657 text-sm font-bold"
              >
                ✕
              </button>
            </div>
